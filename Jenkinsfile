...
// variables:
//      https://github.com/footcrigit/events-app-api-server.git
//      main
//      dtc-092021-u418
//      api-server-image
    ...
    stages {
        stage('Stage 1') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/footcrigit/events-app-api-server.git'
        ...
        stage('Stage 2') {
         ...
         stage('Stage 4') {
            steps {
                ...
                sh "gcloud builds submit -t gcr.io/dtc-092021-u418/api-server-image:v2.${env.BUILD_ID} ."
            }
        }        
         stage('Stage 5') {
            steps {
